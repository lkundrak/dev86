...
gcc -g -D HOST_STUB -o mon86-stub mon86-common.c mon-target.c
...
bcc -ansi -0 -c -o mon-target.o mon-target.c
as86 -0 -o mon86-low.o mon86-low.s
ld86 -0 -d -M -o mon86.bin mon86-low.o mon86-common.o mon-target.o > mon86.map
...
gcc -g -o mon86 mon86-common.c mon-host.c
